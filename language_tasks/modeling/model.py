...
class GPT(nn.Module):
    ...
    def configure_optimizers(self, optimizer_name, 
        ...
        # new PyTorch nightly has a new 'fused' option for AdamW that is much faster
            ...
            optimizer = opt_func(optim_groups, lr=learning_rate, betas=betas, clip=clipping_threshold)
            
        elif optimizer_name == 'sassha':
            optimizer = opt_func(optim_groups, 
                                 lr=learning_rate, 
                                 betas=betas,
                                 weight_decay=weight_decay,
                                 lazy_hessian=lazy_hessian,
                                 eps=eps,
                                 seed=seed)
